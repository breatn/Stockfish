...
int correction_value(const Worker& w, const Position& pos, const Stack* const ss) {
    ...
    const int   matcv  = shared.material_correction_entry(pos)[us].material;
    const int   cntcv =
      m.is_ok()
          ? 8363
    ...
    return 13345 * pcv + 9280 * micv + 11840 * (wnpcv + bnpcv) + 6144 * matcv + cntcv;
}
...
void update_correction_history(const Position& pos,
    ...
    shared.material_correction_entry(pos)[us].material << bonus * 64 / 128;
